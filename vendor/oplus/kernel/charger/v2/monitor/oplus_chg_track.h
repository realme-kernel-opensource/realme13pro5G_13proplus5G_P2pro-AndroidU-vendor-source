...
enum oplus_chg_track_info_flag {
	...
	TRACK_NOTIFY_FLAG_GENERAL_RECORD_LAST = TRACK_NOTIFY_FLAG_DEEP_DISCHG_PROFILE,
	...
	TRACK_NOTIFY_FLAG_SOFTWARE_ABNORMAL_LAST = TRACK_NOTIFY_FLAG_UISOC_KEEP_2_ERROR,
