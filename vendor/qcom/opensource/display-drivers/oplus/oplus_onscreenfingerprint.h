...
struct oplus_ofp_params {
	...
	bool need_to_bypass_gc;                                                 /* indicates whether gc needs to be bypassed in aod/fod scenarios or not */
	bool need_to_bypass_igc;                                                /* indicates whether igc needs to be bypassed in aod/fod scenarios or not */
	/* fod */
