...
static int dsi_panel_power_on(struct dsi_panel *panel)
{
	...
	if (str_equal(panel->oplus_priv.vendor_name, "NT37705")
			...
			|| str_equal(panel->oplus_priv.vendor_name, "AB790")
...
const char *cmd_set_prop_map[DSI_CMD_SET_MAX] = {
	...
	"qcom,mdss-dsi-demura-dbvdbb-command",
	"qcom,mdss-dsi-demura-dbv562-command",
	"qcom,mdss-dsi-demura-dbv3f2-command",
	"qcom,mdss-dsi-demura-dbv1f6-command",
	"qcom,mdss-dsi-demura-dbv008-command",
#endif /* OPLUS_FEATURE_DISPLAY */
#ifdef OPLUS_FEATURE_DISPLAY
...
const char *cmd_set_state_map[DSI_CMD_SET_MAX] = {
	...
	"qcom,mdss-dsi-lhbm-on2-command-state",
	"qcom,mdss-dsi-lhbm-off-command-state",
	"qcom,mdss-dsi-lhbm-off2-command-state",
	"qcom,mdss-dsi-lhbm-tm-on-command-state",
	...
	"qcom,mdss-dsi-demura-dbvdbb-command-state",
	"qcom,mdss-dsi-demura-dbv562-command-state",
	"qcom,mdss-dsi-demura-dbv3f2-command-state",
	"qcom,mdss-dsi-demura-dbv1f6-command-state",
	"qcom,mdss-dsi-demura-dbv008-command-state",
#endif /* OPLUS_FEATURE_DISPLAY */
#ifdef OPLUS_FEATURE_DISPLAY
