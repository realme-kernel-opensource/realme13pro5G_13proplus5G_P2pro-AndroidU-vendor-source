...
extern void sde_cp_crtc_gc_change(struct drm_crtc *crtc_drm);
extern void sde_cp_crtc_igc_change(struct drm_crtc *crtc_drm);
#endif /* OPLUS_FEATURE_DISPLAY */
		...
		struct drm_crtc_state *old_state)
{
	...
	if (oplus_ofp_is_supported()) {
		...
		if (oplus_ofp_need_gc_change(sde_crtc)) {
                        sde_cp_crtc_gc_change(crtc);
                }
		if (oplus_ofp_need_igc_change(sde_crtc)) {
                        sde_cp_crtc_igc_change(crtc);
                }
	}
#endif /* OPLUS_FEATURE_DISPLAY_ONSCREENFINGERPRINT */
