...
#ifndef _CAM_CSIPHY_1_2_3_HWREG_AMBER_H_
#define _CAM_CSIPHY_1_2_3_HWREG_AMBER_H_

#include "../cam_csiphy_dev.h"
#include "cam_csiphy_1_2_3_hwreg_amber.h"

struct csiphy_reg_parms_t csiphy_v1_2_3_amber = {
...
struct csiphy_reg_t csiphy_common_reg_1_2_3_amber[] = {
...
struct csiphy_reg_t csiphy_reset_reg_1_2_3_amber[] = {
	{0x0800, 0x01, 0x02, CSIPHY_DEFAULT_PARAMS},
	{0x0800, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
};

struct csiphy_reg_t csiphy_irq_reg_1_2_3_amber[] = {
...
struct csiphy_reg_t csiphy_2ph_v1_2_3_reg_amber[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
...
struct csiphy_reg_t
	csiphy_2ph_v1_2_3_combo_mode_reg_amber[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		{0x0030, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0024, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0028, 0x00, 0x00, CSIPHY_DNP_PARAMS},
...
struct
csiphy_reg_t csiphy_3ph_v1_2_3_reg_amber[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
...
struct data_rate_settings_t data_rate_delta_table_1_2_3_amber = {
...
#endif /* _CAM_CSIPHY_1_2_3_HWREG_AMBER_H_ */
